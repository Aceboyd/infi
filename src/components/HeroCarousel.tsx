...
export default function HeroCarousel() {
  ...
  return (
    <div className="relative h-full min-h-[570px] w-full max-w-none overflow-hidden border-0 bg-[#101513] lg:min-h-[650px]">
      <AnimatePresence mode="wait">
        <motion.div key={slide} initial={{ opacity: 0, scale: 1.08 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.98 }} transition={{ duration: 0.8 }} className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: `linear-gradient(180deg, rgba(16,21,19,.52), rgba(16,21,19,.64)), url(${slide})` }} />
      </AnimatePresence>
